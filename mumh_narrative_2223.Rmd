...
:::{.col-md-12} 
`r infoBox_border(header = "Changes to these statistics", text = paste0("For this release, we have combined our annual and quarterly publications. The supporting summary tables have been expanded to provide quarterly and monthly data at a more granular level than previously released. Our methodology for assigning items and patients to Integrated Care Board (ICB) and Index of Multiple Deprivation (IMD) quintile is now based on patient postcode rather than practice postcode. We are interested in any feedback about the publication, which you can send by using our ", htmltools::HTML(paste("<a href='",config$stats_survey_link,"'>Official Statistics feedback survey</a>")),"."), width = "100%")` 
::: 
::::
...
:::{.col-md-4}
`r infoBox_no_border("", text = "<b>Antidepressant items and identified patients continued to increase, with 86.3 million antidepressant items prescribed.</b>", width = "100%")`
:::
:::{.col-md-4}
...
:::
:::{.col-md-4}
`r infoBox_no_border("", text = "<b>Key finding here</b>", width = "100%")`
:::
::::

Of the five British National Formulary (BNF) sections covered in these statistics, 
...
Source: [Annual statistical summary tables - Antidepressant drugs](`r config$fy_0403_link`)
...
:::
:::{.col-md-4}
`r infoBox_no_border("", text = "<b> 8.56 million identified patients were prescribed an antidepressant in 2022/23.</b>", width = "100%")`
:::
:::{.col-md-4}
...
Source: [Quarterly statistical summary tables - Antidepressant drugs](`r config$quart_0403_link`)
...
:::
:::{.col-md-6}
`r infoBox_no_border("", text = "<b> 6.72 million identified patients were prescribed an antidepressant in Q4 2022/23.</b>", width = "100%")`
:::
::::
...
:::
:::{.col-md-6}
`r infoBox_no_border("", text = "<b>Almost 40% more patients in the most deprived areas compared to the least deprived areas.</b>", width = "100%")`
:::
::::
...
Source: [Annual statistical summary tables - Hypnotics and anxiolytics](`r config$fy_0401_link`)
...
:::
:::{.col-md-4}
`r infoBox_no_border("", text = "<b> 1.9 million identified patients were prescribed a hypnotics and anxiolytics drug in 2022/23.</b>", width = "100%")`
:::
:::{.col-md-4}
...
Source: [Quarterly statistical summary tables - Hypnotics and anxiolytics](`r config$quart_0401_link`)
...
Source: [Annual statistical summary tables - Drugs used in psychoses and related disorders](`r config$fy_0402_link`)
...
:::
:::{.col-md-6}
`r infoBox_no_border("", text = "<b> 850,000 identified patients were prescribed an antipsychotics item in 2022/23.</b>", width = "100%")`
:::
::::
...
Source: [Quarterly statistical summary tables - Drugs used in psychoses and related disorders](`r config$quart_0402_link`)
...
Source: [Annual statistical summary tables - Central nervous system (CNS) stimulants and drugs used for ADHD ](`r config$fy_0404_link`)
...
Source: [Quarterly statistical summary tables - Central nervous system (CNS) stimulants and drugs used for ADHD](`r config$quart_0404_link`)

::::{.row style="display: flex; padding-bottom: 15px;"}
:::{.col-md-4}
`r infoBox_no_border("", text = "<b> 687,000 Central nervous system (CNS) stimulants and drugs used for ADHD  items prescribed in Q4 2022/23.</b>", width = "100%")`
:::
:::{.col-md-4}
...
:::
:::{.col-md-6}
`r infoBox_no_border("", text = "<b> Since last year prescribing has risen by 31.8% in adults and 12.5% in children.</b>", width = "100%")`
:::
::::
...
Source: [Annual statistical summary tables - Drugs for dementia](`r config$fy_0411_link`)
...
Source: [Quarterly statistical summary tables - Drugs for dementia](`r config$quart_0411_link`)
...
:::
:::{.col-md-4}
`r infoBox_no_border("", text = "<b> 243,000 identified patients were prescribed a drugs for dementia item in Q4 2022/23.</b>", width = "100%")`
:::
:::{.col-md-4}
...
::::{.row style="display: flex; padding-bottom: 15px;"}
:::{.col-md-4}
`r infoBox_no_border("", text = "<b> Antidepressants, hypnotics and anxiolytics, and antipsychotics have mostly remained within the range of values expected based on pre-pandemic trends.</b>", width = "100%")`
:::
:::{.col-md-4}
`r infoBox_no_border("", text = "<b>CNS stimulants and drugs for ADHD have continued to increase beyond the range of expected items to be prescribed, a long term trend.</b>", width = "100%")`
:::
:::{.col-md-4}
`r infoBox_no_border("", text = "<b>Drugs for dementia have remained below the number of expected items to be prescribed since June 2022.</b>", width = "100%")`
:::
::::

The number of expected prescription items for each BNF section during this period have been calculated by extrapolating figures for March 2020 to March 2023 according to:
...
Between March 2020 and March 2023 there were 253 million antidepressant items prescribed to identified patients with a known age and gender. This was only 0.57% more than the 252 million items expected based on historical trends, so antidepressant items remained well within the expected values for this period.
...
There were 42.0 million hypnotics and anxiolytics items prescribed between March 2020 and March 2023 to identified patients with a known age and gender. This closely followed the expected number of items for this time period, as there were 0.42% more items prescribed than the 41.8 million items expected based on historical trends. Hypnotics and anxiolytics therefore stayed within the range of values expected for items in this period.
...
There were 39.4 million antipsychotics items prescribed from March 2020 to March 2023 to identified patients with known age and gender. This was 1.69% less than the 40.0 million items that were expected to be prescribed. Over this period antipsychotics items stayed mostly within the range of expected values. However, a small number of months have shown prescribing slightly lower than this range, most recently in January and February 2023. Antipsychotics items have returned to being within expected values for March 2023.
...
There were 12.3 million drugs for dementia items prescribed from March 2020 to March 2023 to identified patients with known age and gender. This was significantly lower than the 13.9 million items expected to be prescribed, at 11.6% less. In the past year, all months except for June 2022 have fallen outside the range of expected values. Although prescribing follows the seasonal patterns expected, drugs for dementia items remain consistently lower than expected based on historical trends.
