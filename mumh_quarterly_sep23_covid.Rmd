...
:::{.col-md-6}
`r infoBox_no_border("", text = "<b>Antidepressants and hypnotics and anxiolytics generally remained within the range of expected values, based on pre-pandemic trends.</b>", width = "100%")`
:::
:::{.col-md-6}
`r infoBox_no_border("", text = "<b>Antipsychotics were below the range of expected items in July and September 2023.</b>", width = "100%")`
:::
:::{.col-md-6}
`r infoBox_no_border("", text = "<b>CNS stimulants and drugs for ADHD continued to increase beyond the range of expected items to be prescribed.</b>", width = "100%")`
:::
::::
