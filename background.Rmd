...
### 3.2. Additional quarterly breakdowns {.toc-ignore}
...
### 3.3. Quarterly section summaries {.toc-ignore}

From the Q1 2023/24 quarterly release, we have split the publication into smaller sections, an overall summary plus one for each BNF Section and one for the modelling based on previous prescribing trends.
