...
::::{.row style="display: flex; padding-bottom: 15px;"}
:::{.col-md-4}
`r infoBox_no_border("", text = "<b> The number of identified patients under 17 receiving antidepressants remains steady.</b>", width = "100%")`
:::
::::
...
:::
:::{.col-md-4}
`r infoBox_no_border("", text = "<b>Barbiturates have the smallest volume of prescribing and have seen the biggest decrease. </b>", width = "100%")`
:::
::::
...
NHS Bristol, North Somerset and South Gloucestershire ICB had the lowest, where out of every 1000 people in the population, an estimated 13 patients were prescribed at least one antidepressant item in 2022/23.
...
::::{.row style="display: flex; padding-bottom: 15px;"}
:::{.col-md-4}
`r infoBox_no_border("", text = "<b> Placeholder for whether sections remained along expected trends or not.</b>", width = "100%")`
:::
:::{.col-md-4}
`r infoBox_no_border("", text = "<b>Placeholder for CNS ADHD findings if notable </b>", width = "100%")`
:::
:::{.col-md-4}
`r infoBox_no_border("", text = "<b>Placeholder for any other findings.</b>", width = "100%")`
:::
::::
...
The reported IMD quintile, where 1 represents the 20% most deprived areas and 5 the 20% least deprived areas, is derived from the postcode of the patient an item has been prescribed to. There are a small number of items each year that we have reported as having an unknown IMD decile. These are items where we have been unable to match the patient postcode to a postcode in the National Statistics Postcode Lookup (NSPL) - May 2023.
...
The patient deprivation measures given in these statistics are based upon the LSOA of the postcode of the prescribing organisation as matched to the May 2023 NSPL file. However, higher geographies included in the statistical summary tables of this publication, such as ICB, use NHSBSA administrative records, not geographical boundaries, and more closely reflect the operational organisation of practices than other geographical data sources.
