...
:::
:::{.col-md-6}
`r infoBox_no_border("", text = "<b>The cost of prescribed drugs for dementia items was £6.8 million.</b>", width = "100%")`
:::
::::
...
::::{.row style="display: flex; padding-bottom: 15px;"}
:::{.col-md-4}
`r infoBox_no_border("", text = "<b>1.1 million drugs for dementia items prescribed in Q2 2023/24.</b>", width = "100%")`
:::
:::{.col-md-4}
`r infoBox_no_border("", text = "<b>250,000 identified patients received a drugs for dementia item in Q2 2023/24.</b>", width = "100%")`
:::
:::{.col-md-4}
`r infoBox_no_border("", text = "<b>Drugs for dementia items and patients have increased above pre-COVID-19 pandemic levels, after a decline over the initial COVID-19 period.</b>", width = "100%")`
:::
::::
...
::::{.row style="display: flex; padding-bottom: 15px;"}
:::{.col-md-6}
`r infoBox_no_border("", text = "<b>The cost of prescribed drugs for dementia items in Q2 2023/24 was £6.8 million.</b>", width = "100%")`
:::
:::{.col-md-6}
`r infoBox_no_border("", text = "<b>The cost of drugs for dementia items has continued the recent upwards trend.</b>", width = "100%")`
:::
::::
...
::::{.row style="display: flex; padding-bottom: 15px;"}
:::{.col-md-6}
`r infoBox_no_border("", text = "<b>An average of 200,000 patients per month received prescribing for drugs for dementia items over the last 12 months.</b>", width = "100%")`
:::
:::{.col-md-6}
`r infoBox_no_border("", text = "<b>Drugs for dementia items increased by 4.7% over the last 12 months, compared to the previous 12 month period.</b>", width = "100%")`
:::
::::
