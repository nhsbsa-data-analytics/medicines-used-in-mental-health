...
Hypnotics and anxiolytics items and identified patients were fairly level across all four quarters of 2022/23. Despite the overall decrease over the year there was a slight increase in identified patients from Q3 2022/23 to Q4 2022/23 from 1.04 million to 1.06 million. This was not reflected in the number of items, which stayed similar across Q4 2022/23. Overall, both patients and items are less than they were during the same quarter in 2021/22. 
...
As seen in previous years, 2022/23 had noticeable skew in prescribing across gender, with 457,000 female patients and 391,000 male patients who received at least one antipsychotics item. However the differences by gender were smaller than some of the other BNF sections in this publication.

Female patients aged 90+ were the largest group across all age and gender groups at 4.41% of all identified patients. This was a change from 2021/22 where female patients aged 50-54 were the largest group. In 2022/23 female patients aged 50-54 became the second largest group, representing 4.40% of identified patients. The largest group of male patients was those aged 55-59, with 4.33% of identified patients who were male.
...
In 2022/23 NHS Devon ICB was the ICB with the highest estimated number of identified patients who received at least one antipsychotics item per 1,000 residents, an estimated 27 patients per 1,000 population.

NHS Bristol, North Somerset and South Gloucestershire ICB had the lowest, where out of every 1,000 people in the population, an estimated 13 patients were prescribed at least one antipsychotics item in 2022/23.
...
In 2022/23, an estimated 53,700 identified patients were prescribed drugs for dementia items in the most deprived areas in England. This was 26% less identified patients that received prescribing for drugs for dementia items in the least deprived areas. In general, more people were prescribed drugs for dementia items from practices in the least deprived areas in 2022/23. This pattern has remained consistent since 2015/16. 
...
In 2022/23 NHS Gloucestershire ICB was the ICB with the highest estimated number of identified patients prescribed a drugs for dementia item per 1,000 residents, with an estimated 9 patients per 1,000 population.
...
The number of expected prescription items for the below sections during this period have been calculated by extrapolating figures for March 2020 to March 2023 according to:
...
`r infoBox_border("Prediction interval (PI)", text = "A range calculated based on the uncertainty around the fit of the model. A 95% PI means that if a new observation is taken from the population the model is based on, it is likely to fall within the interval of predicted values 95% of the time. A 99% PI means the new observation is likely to fall within the interval of predicted values 99% of the time.", width = "100%")`
...
Between March 2020 and March 2023, there were 256 million antidepressant items prescribed.

Of these antidepressant items, 253 million were prescribed to identified patients with a known age and gender over the same period. This was only 0.57% more than the 252 million items expected based on historical trends, so antidepressant items remained well within the expected values for this period.
...
There were 43.4 million hypnotics and anxiolytics items prescribed between March 2020 and March 2023.

Across the same period, 42.0 million hypnotics and anxiolytics items were prescribed to identified patients with a known age and gender. This closely followed the expected number of items for this time period, as there were 0.42% more items prescribed than the 41.8 million items expected based on historical trends. Hypnotics and anxiolytics therefore stayed within the range of values expected for items in this period.
...
From March 2020 to March 2023, 40.7 million antipsychotics items were prescribed.

There were 39.4 million antipsychotics items prescribed within the same time period to identified patients with known age and gender. This was 1.69% less than the 40.0 million items that were expected to be prescribed. Over this period antipsychotics items stayed mostly within the range of expected values. However, a small number of months have shown prescribing slightly outside this range, most recently in January and February 2023. Antipsychotics items have returned to being within expected values for March 2023.
...
From March 2020 to March 2023, 6.68 million CNS stimulants and drugs used for ADHD items were prescribed.

During this same time, 5.86 million CNS stimulants and drugs used for ADHD items were prescribed to identified patients with known age and gender. This was outside the expected range of values for this period, at 13.2% more than the 5.17 million items expected based on historical trends. Since February 2022, CNS stimulants and drugs used for ADHD items have remained consistently higher than expected based on historical trends. Since 2015/16 there has always been an increase between February and March, with a noticeably steeper increase between February and March 2023 than previous years.
...
There were 12.7 million drugs for dementia items prescribed between March 2020 and March 2023.

Of these items, 12.3 million drugs for dementia items were prescribed to identified patients with known age and gender across the same time period. This significantly lower than the 13.9 million items expected to be prescribed, at 11.6% less. In the past year, all months except for June 2022 have fallen outside the range of expected values. Although prescribing follows the seasonal patterns expected, drugs for dementia items remain consistently lower than expected based on historical trends.
