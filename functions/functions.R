...
#function to download and aggregate England mid-year population by age and gender
national_pop_agegen <- function(url = "https://www.ons.gov.uk/file?uri=/peoplepopulationandcommunity/populationandmigration/populationestimates/datasets/estimatesofthepopulationforenglandandwales/ukpopulationestimates1838to2022/ukpopulationestimates18382022.xlsx"){
  temp1 <- tempfile()
  nat_pop_url <-
  ...
  pop_all <- readxl::read_xlsx(temp1,
                               ...
                               col_names = TRUE) |>
    stats::na.omit() |>
    tidyr::pivot_longer(cols = `Mid-2022`:`Mid-2015`,
                        names_to = "Year",
