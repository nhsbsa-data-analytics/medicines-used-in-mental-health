...
::::{.row style="display: flex; padding-bottom: 15px;"}
:::{.col-md-4}
`r infoBox_no_border("", text = "<b> 2.14 million patients in the most deprived areas in England.</b>", width = "100%")`
:::

In 2022/23, there were 2.14 million identified patients receiving prescribing for antidepressants in the most deprived areas in England. This was 24.9% of all identified patients, and 39.8% higher than the least deprived areas.
...
annual_0403$prescribing_in_children %>%
  ...
  dplyr::mutate(`Total Identified Patients` = (`Total Identified Patients` / 1000000)) %>%
...
### 5.5 Statistical Disclosure Controld (SDC) {.toc-ignore}
