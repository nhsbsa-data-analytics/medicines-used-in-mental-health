...
:::
:::{.col-md-4}
`r infoBox_no_border("", text = "<b>Hypnotics and anxiolytics items and identified patients increased compared to the previous quarter, though the long term trend is downwards.</b>", width = "100%")`
:::
::::
