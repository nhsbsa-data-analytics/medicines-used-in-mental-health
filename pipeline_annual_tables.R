...
# 0401 Hypnotics and anxiolytics - annual
...
accessibleTables::write_sheet(
  ...
  annual_0401$national_population,
  14
)
...
accessibleTables::write_sheet(
  ...
  annual_0402$national_population,
  14
)
...
accessibleTables::write_sheet(
  ...
  annual_0404$national_population,
  14
)
...
write_sheet(
  ...
  "Medicines Used in Mental Health - England - 2015/16 to 2022/23 - Prescribing in adults and children, age bands 17 and under to 18 and over",
  c("1. Field definitions can be found on the 'Metadata' tab."),
  annual_0404$prescribing_in_children,
  14
)
...
accessibleTables::write_sheet(
  ...
  annual_0411$national_population,
  14
)
