...
`r mumhquarterly::infoBox_border(header = "Changes to these statistics", text = paste0("For this release, we have split the publication into smaller summaries,one for each BNF Section and one for the modelling based on previous prescribing trends. We are interested in any feedback about the publication or these changes, which you can send by using our ", htmltools::HTML("<a href='https://online1.snapsurveys.com/Official_Statistics_Feedback'>Official Statistics feedback survey</a>"),"."), width = "100%")`
...
:::{.col-md-4}
`r infoBox_no_border("", text = "<b>22 million antidepressant items were prescribed to an estimated 6.7 million identified patients.</b>", width = "100%")`
:::
:::{.col-md-4}
`r infoBox_no_border("", text = "<b>The costs of prescribed antidepressant items was £60 million.</b>", width = "100%")`
:::
:::{.col-md-4}
`r infoBox_no_border("", text = "<b>Prescribing of drugs for dementia items remained below expected values based on pre-pandemic trends.</b>", width = "100%")`
:::
::::
...
Hypnotics and anxiolytics saw a 2.4% decrease in prescribed items from the previous quarter and a 3.2% fewer identified patients.
...
The data in this publication covers the period from April 2018 to June 2023. Q1, Q2, Q3, and Q4 refer to different periods within a financial year. 
...
For this release, we have split the publication into smaller summaries, one for each BNF section and one that explores the impact of the COVID-19 pandemic on prescribing trends.
